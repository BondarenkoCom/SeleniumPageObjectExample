...
namespace PageObjectPatternSelenium.ChromeConstants
{
    public class PageAuthForChrome
    {
        ...
        public static string ProductsInProfile = "/html[1]/body[1]/header[1]/nav[1]/div[1]/div[1]/div[2]/div[2]/div[1]/a[1]";
        public static string ErrorAuthMessage = "/html/body/div[1]/div/div/div/div/div[1]";
    }
}
